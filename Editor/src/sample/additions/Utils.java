...
public class Utils {
    ...
    public static ArrayList<String> initLeague() {
    ...
    public static ArrayList<String> initEPL() {
    ...
    public static ArrayList<String> initSLL() {
    ...
    public static ArrayList<String> initISA() {
    ...
    public static ArrayList<String> initFL1() {
    ...
    public static ArrayList<String> initGB1() {
    ...
    public static ArrayList<String> initRPL() {
